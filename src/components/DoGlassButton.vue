<template>
  <div class="do-glass-button">
    ...
    <img
        src="https://plus.unsplash.com/premium_photo-1748960861503-99b1f5412a81?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwxfHx8ZW58MHx8fHx8"
        alt=""
        style="width: 100%; display: block"
    />

    <div style="display: flex; gap: 16px; margin-top: 20px; position: fixed; bottom: 16px; width: 100%; padding: 0 16px">
      <div class="liquid_glass-wrapper" style="width: 54px; height: 54px; --border-radius: 60px">
        ...
        <div class="icon">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="rgba(255, 32, 86, 0.7)"
      ...
      <div class="liquid_glass-wrapper" style="--border-radius: 26px; flex: 1">
        ...
        <div style="z-index: 5; display: flex; align-items: center; width: 100%; padding: 0 24px; gap: 16px">
          <img
          ...
          <div style="margin-right: auto; color: rgba(255, 255, 255, 0.8)">
            <p style="font-weight: bold; font-size: 16px">Konoyo</p>
            <p style="font-size: 12px">Tim Hecker</p>
          </div>

          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="rgba(255,255,255,0.8)"
               style="width: 28px; height: 28px">
            <path
